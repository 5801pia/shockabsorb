...
using ShockAbsorber.Converters;
using ShockAbsorber.Properties;
    ...
    public partial class MainWindow : Form
    {
        ...
        private void InitializeVariables()
        {
            ...
            for (int i = 0; i < parametersData.Count; i++)
            {
                ...
                if (parameters[i] == Parameter.ScrewDirection)
                {
                    comboBox1.SelectedIndex = (int)parametersData[i].Value;
                    _controlsDictionary.Add(parameters[i], comboBox1);
                }
                else
                {
                    _controlsDictionary.Add(parameters[i], textBoxes[i]);
                }
            }
        }
